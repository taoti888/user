...
const (
	...
	User_AddRolesToUser_FullMethodName = "/proto.User/AddRolesToUser"
)
...
type UserClient interface {
	...
	AddRolesToUser(ctx context.Context, in *AddRolesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *userClient) AddRolesToUser(ctx context.Context, in *AddRolesRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, User_AddRolesToUser_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	AddRolesToUser(context.Context, *AddRolesRequest) (*emptypb.Empty, error)
...
func (UnimplementedUserServer) AddRolesToUser(context.Context, *AddRolesRequest) (*emptypb.Empty, error) {
...
func _User_AddRolesToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).AddRolesToUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_AddRolesToUser_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).AddRolesToUser(ctx, req.(*AddRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _User_AddRolesToUser_Handler,
		},
	},
